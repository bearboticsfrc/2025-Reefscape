...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  private final double A = 0.41;
  private final double S = 0.0;
  private final double G = 2.26;
  private final double V = 3.08;
  ...
  //   double feedForwardValue = feedforward.calculate(currentState.position,
